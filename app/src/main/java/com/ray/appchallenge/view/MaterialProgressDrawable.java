...
public class MaterialProgressDrawable extends Drawable implements Animatable {
    ...
    public MaterialProgressDrawable(final Context context, final View parent) {
        mParent = parent;
    ...
    private void setSizeParameters(final double progressCircleWidth, final double progressCircleHeight,
            final double centerRadius, final double strokeWidth, final float arrowWidth, final float arrowHeight) {
     ...
     */
    public void updateSizes(@ProgressDrawableSize final int size) {
        if (size == LARGE) {
     ...
     */
    public void setArrowScale(final float scale) {
     ...
     */
    public void setStartEndTrim(final float startAngle, final float endAngle) {
    ...
    /**
     * Set the colors used in the progress animation from color resources. The first color will also be the color of the
    ...
    private final Callback mCallback = new Callback() {
        @Override
        public void invalidateDrawable(final Drawable d) {
            invalidateSelf();
        }

        @Override
        public void scheduleDrawable(final Drawable d, final Runnable what, final long when) {
            scheduleSelf(what, when);
        }

        @Override
        public void unscheduleDrawable(final Drawable d, final Runnable what) {
            unscheduleSelf(what);
        }
    };
    ...
    private static class Ring {
        ...
        public Ring(final Callback callback) {
            mCallback = callback;
         ...
         */
        public void setArrowDimensions(final float width, final float height) {
         ...
         */
        public void draw(final Canvas c, final Rect bounds) {
        ...
        private void drawTriangle(final Canvas c, final float startAngle, final float sweepAngle, final Rect bounds) {
            if (mShowArrow) {
                if (mArrow == null) {
         ...
         */
        public void setColors(@NonNull final int[] colors) {
            mColors = colors;
        ...
        @SuppressWarnings("unused")
        public void setStartTrim(final float startTrim) {
        ...
        @SuppressWarnings("unused")
        public void setEndTrim(final float endTrim) {
            mEndTrim = endTrim;
            invalidateSelf();
        }
         ...
         */
        public void setCenterRadius(final double centerRadius) {
         ...
         */
        public void setShowArrow(final boolean show) {
            if (mShowArrow != show) {
                mShowArrow = show;
                invalidateSelf();
            }
