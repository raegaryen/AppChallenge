 ...
 * Private class created to work around issues with AnimationListeners being called before the animation is actually
 * complete and support shadows on older platforms.
 *
 * @hide
 */
class CircleImageView extends ImageView {
    ...
    public CircleImageView(final Context context, final int color, final float radius) {
        super(context);
     ...
     */
    public void setBackgroundColor(final int colorRes) {
    ...
    private class OvalShadow extends OvalShape {
        ...
        public OvalShadow(final int shadowRadius, final int circleDiameter) {
            super();
